...
public class RobotMap {
    ...
    public static Encoder shooterActivateQuadratureEncoder1;
    ...
    public static void init() {
        ...
        LiveWindow.addActuator("Gear Arm Prototype", "Arm Double Solenoid", gearArmPrototypeArmDoubleSolenoid);
        
        shooterActivateCANTalon1 = new CANTalon(5);
        LiveWindow.addActuator("ShooterActivate", "CAN Talon 1", shooterActivateCANTalon1);
        
        shooterActivateQuadratureEncoder1 = new Encoder(2, 3, false, EncodingType.k4X);
        LiveWindow.addSensor("ShooterActivate", "Quadrature Encoder 1", shooterActivateQuadratureEncoder1);
        shooterActivateQuadratureEncoder1.setDistancePerPulse(1.0);
        shooterActivateQuadratureEncoder1.setPIDSourceType(PIDSourceType.kRate);
